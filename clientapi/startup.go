...
func (s *startupService) ListVariables(options api.PaginationOptions) ([]*api.StartupVariable, *api.Meta, error) {
...
func (s *startupService) UpdateVariable(options api.UpdateVariableOptions) (*api.StartupVariable, error) {
